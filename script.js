...
searchBtn.addEventListener("click", function () {
  ...
  if (stateInputEl.value === "null") {
    var fiveDayApi = "https://api.openweathermap.org/data/2.5/forecast?q=" + cityInput.value + "&appid=a215cfdcaaef2536002948ba6c285538";
  } else {
   fiveDayApi = "https://api.openweathermap.org/data/2.5/forecast?q=" + cityInput.value + ",US-" + stateInputEl.value.toUpperCase() + "&appid=a215cfdcaaef2536002948ba6c285538";
  }
      ...
      for (let i = 0; i < cities.length; i++) {
        ...
        fetch(oneCallApi)
          ...
          .then(function (dataTwo) {
            ...
            weatherDesEl.textContent = dataTwo.current.weather[0].description.toUpperCase()
            ...
            function dayOne () {
              ...
              dayOneEL.children[2].textContent = data.list[3].dt_txt.substring(0, 10)
            
              dayOneEL.children[3].textContent = "Temp: " + dataTwo.daily[0].temp.day  
            
              dayOneEL.children[4].textContent = "Wind: " + dataTwo.daily[0].wind_speed
            
              dayOneEL.children[5].textContent = "Humidity: " + dataTwo.daily[0].humidity

              let dayOneIconCode = dataTwo.daily[1].weather[0].icon

              dayOneIconEL.src = `https://openweathermap.org/img/wn/${dayOneIconCode}@2x.png`

              dayOneDesEl.textContent = dataTwo.daily[1].weather[0].description.toUpperCase()
            }

            function dayTwo () {

              dayTwoEL.children[2].textContent = data.list[11].dt_txt.substring(0, 10)
            
            
              dayTwoEL.children[3].textContent = "Temp: " + dataTwo.daily[1].temp.day  
            
              dayTwoEL.children[4].textContent = "Wind: " + dataTwo.daily[1].wind_speed
            
              dayTwoEL.children[5].textContent = "Humidity: " + dataTwo.daily[1].humidity

              let dayTwoIconCode = dataTwo.daily[2].weather[0].icon

              dayTwoIconEL.src = `https://openweathermap.org/img/wn/${dayTwoIconCode}@2x.png`

              dayTwoDesEl.textContent = dataTwo.daily[2].weather[0].description.toUpperCase()
            }

            function dayThree () {

              dayThreeEL.children[2].textContent = data.list[19].dt_txt.substring(0, 10)
            
            
              dayThreeEL.children[3].textContent = "Temp: " + dataTwo.daily[2].temp.day  
            
              dayThreeEL.children[4].textContent = "Wind: " + dataTwo.daily[2].wind_speed
            
              dayThreeEL.children[5].textContent = "Humidity: " + dataTwo.daily[2].humidity
            ...
            dayThreeDesEl.textContent = dataTwo.daily[3].weather[0].description.toUpperCase()
            }

            function dayFour () {

              dayFourEL.children[2].textContent = data.list[27].dt_txt.substring(0, 10)
            
            
              dayFourEL.children[3].textContent = "Temp: " + dataTwo.daily[3].temp.day  
            
              dayFourEL.children[4].textContent = "Wind: " + dataTwo.daily[3].wind_speed
            
              dayFourEL.children[5].textContent = "Humidity: " + dataTwo.daily[3].humidity
              ...
              dayFourDesEl.textContent = dataTwo.daily[4].weather[0].description.toUpperCase()
            }

            function dayFive () {

              dayFiveEL.children[2].textContent = data.list[35].dt_txt.substring(0, 10)
            
              dayFiveEL.children[3].textContent = "Temp: " + dataTwo.daily[4].temp.day  
            
              dayFiveEL.children[4].textContent = "Wind: " + dataTwo.daily[4].wind_speed
            
              dayFiveEL.children[5].textContent = "Humidity: " + dataTwo.daily[4].humidity
              ...
              dayFiveDesEl.textContent = dataTwo.daily[5].weather[0].description.toUpperCase()
            }
